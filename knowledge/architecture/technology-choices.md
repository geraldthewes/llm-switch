# Technology Choices for llm-switch
...
7. llm-swith designed to be run inside a docker container, to be deployed on a nomad cluster infrastructure with access to consul and vault

8. Current services used in the cluster. You do not need to use, if needed you can recommend other choices, but you need a reasaon to do so:
