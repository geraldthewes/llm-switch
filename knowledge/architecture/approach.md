...
C4Context
    ...
    Boundary(boundaryLlmSwitch, "llm-switch\n<<System>>\nGolang 1.21+, Docker 24.0+\nProvides Prometheus metrics at /metrics, Grafana dashboard llm-switch-overview, hardware-aware routing (memory-priority), respects Kubernetes Node Affinity for GPU scheduling", solid) {
